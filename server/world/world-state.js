...
const { EntitiesManager } = require('./entities-manager');
    ...
    getState() {
        try {
            const state = {
                ...
                entities: this.entities.getState(),
                lastUpdate: this.lastUpdate
            };
            return state;
        } catch (error) {
            console.error('[WorldState] getState error:', error);
            console.error('  terrain:', this.terrain ? 'OK' : 'NULL');
            console.error('  buildings:', this.buildings ? 'OK' : 'NULL');
            console.error('  decorations:', this.decorations ? 'OK' : 'NULL');
            throw error;
        }
    }
